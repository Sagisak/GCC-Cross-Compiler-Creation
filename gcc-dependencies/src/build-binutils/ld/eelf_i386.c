...
gldelf_i386_before_plugin_all_symbols_read (void)
{
  ldelf_before_plugin_all_symbols_read (true, false,
				        false,
					false,
					32, "/home/leonardo/Documents/GitHub/GCC-Cross-Compiler-Creation/cross");
}
...
gldelf_i386_after_open (void)
{
  ldelf_after_open (true, false,
		    false, false, 32, "/home/leonardo/Documents/GitHub/GCC-Cross-Compiler-Creation/cross");
}
...
OUTPUT_ARCH(i386)\n\
ENTRY(_start)\n\
SEARCH_DIR(\"=/home/leonardo/Documents/GitHub/GCC-Cross-Compiler-Creation/cross/i686-elf/lib\"); SEARCH_DIR(\"=/usr/local/lib\"); SEARCH_DIR(\"=/lib\"); SEARCH_DIR(\"=/usr/lib\");\n\
SECTIONS\n\
{\n\
